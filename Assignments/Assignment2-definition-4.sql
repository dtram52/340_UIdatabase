...
VALUES ('Adam','Lowd','1975-01-02','2009-01-01');
...
INSERT INTO employee (first_name,last_name,dob,date_joined)
VALUES ('Deena','Young','1984-03-21','2013-11-10');
...
-- notes - NULL
INSERT INTO project (cid,name,notes)
VALUES ((SELECT id FROM client WHERE first_name='David' AND last_name='Atkins'),
        'Eclipse',NULL);
...
INSERT INTO project (cid,name,notes)
VALUES ((SELECT id FROM client WHERE first_name='Daniel' AND last_name='Jensen'),
        'Moon',NULL);
...
VALUES ((SELECT id FROM employee WHERE first_name='Adam' AND last_name='Lowd'),
